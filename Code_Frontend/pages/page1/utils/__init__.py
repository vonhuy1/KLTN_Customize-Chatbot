...
def render_footer():
    for _ in range(10):
        st.write('\n')
    st.markdown(
        "<br><hr><center>Copyright© 2024 Vo Nhu Y  & Nguyen Quang Phuc. All rights reserved</center><hr>",
...
def render_github_info(zone):
    with zone.container():
        for i in range(1):
            st.write("\n")
        st.markdown('<a href="https://github.com/vonhuy1/Test_KLTN" target="_blank" rel="chatgpt-streamlit">'
